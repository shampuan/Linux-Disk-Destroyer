...
class LinuxDiskDestroyer(QWidget):
        ...
        self.translations = {
            'en': {
                ...
                'about_text': (
                    ...
                    "Developer: Zeus & Google Gemini https://github.com/shampuan/<br>"
                    "Date: July 18, 2025<br><br>"
                    "A secure disk wiping tool for Debian-based Linux systems.<br>"
                    "Uses 'shred' for secure data destruction.<br><br>"
                    "Developed with Python3 and PyQt5.<br>"
                    "Warning: Use the program carefully. This operation is irreversible!"
                ),
            ...
            'tr': {
                ...
                'about_text': (
                    ...
                    "Sürüm 1.0<br>"
                    "Lisans: GNU GPLv3<br>"
                    "Geliştiren: Zeus & Google Gemini https://github.com/shampuan/<br>"
                    "Tarih: 18 Temmuz 2025<br><br>"
                    "Debian tabanlı Linux sistemleri için güvenli bir disk silme aracı.<br>"
                    "Güvenli veri yok etme için 'shred' kullanır.<br><br>"
                    "Python3 ve PyQt5 ile geliştirilmiştir.<br>"
                    "Uyarı: Programı dikkatli kullanın. Bu işlem geri alınamaz!"
                ),
    ...
    def show_about_dialog(self):
        QMessageBox.about(self, self.get_translation('about_title'),
